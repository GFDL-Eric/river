...
integer :: pii, pjj, pii2, pjj2, pii3, pjj3, pii4, pjj4, pii5, pjj5, loopexit
         ...
         if (tocell(i,j,n) == mval_mdl) go to 170
             ...
             if (cell_a(i,j,n) == mval_mdl) then
                 write (6,'(a,2i5,2f10.3,2f10.0)') 'cell_a is missing value, ', j, i, &
                     lat(i,j,n), lon(i,j,n), tocell(i,j,n), cell_a(i,j,n)
                 stop 120
             endif
...
!                endif
                ...
                if (tocell(i1,j1,n1) == out_flow(ii,jj)) then
                  if (infinite_loop_check(ii,jj,pii,pjj) .and. &
                      infinite_loop_check(pii,pjj,pii2,pjj2) .and. &
                      infinite_loop_check(pii2,pjj2,pii3,pjj3) .and. &
                      infinite_loop_check(pii3,pjj3,pii4,pjj4) .and. &
                      infinite_loop_check(pii4,pjj4,pii5,pjj5) .or. loopexit > 9999) then
                      write (6,'(a,a,i5,a,i5,a,i5,a,i5)') &
                        'ERROR: Infinite tocell loop encountered, ', ' j=',j, ' i=',i, ' j1=',j1, ' i1=',i1
                      write (6,'(a,i5,a,i5)') ' jj=',jj, ' ii=',ii
                      write (6,'(a,i5,a,i5)') ' pjj=',pjj, ' pii=',pii
                      write (6,'(a,i5,a,i5)') ' pjj2=',pjj2, ' pii2=',pii2
                      write (6,'(a,i5,a,i5)') ' pjj3=',pjj3, ' pii3=',pii3
                      write (6,'(a,i5,a,i5)') ' pjj4=',pjj4, ' pii4=',pii4
                      write (6,'(a,i5,a,i5)') ' pjj5=',pjj5, ' pii5=',pii5
                      write (6,'(a,f8.3,a,f8.3,a,f4.0)') &
                        ' lat=',lat(i,j,n), ' lon=',lon(i,j,n), ' tocell=',tocell(i,j,n)
                      write (6,'(a,f4.0,a,f4.0)') &
                        ' current outflow=',out_flow(ii,jj), ' previous outflow=',out_flow(pii,pjj)
                      write (6,'(a,f4.0,a,f4.0)') &
                        ' p2 outflow=',out_flow(pii2,pjj2), ' p3 outflow=',out_flow(pii3,pjj3)
                      write (6,'(a,f4.0,a,f4.0)') &
                        ' p4 outflow=',out_flow(pii4,pjj4), ' p5 outflow=',out_flow(pii5,pjj5)
                      write (6,'(a,i5)') ' loopexit=',loopexit
                      stop 120
                  endif
!                    write (6,*) 'tocell = out_flow', ii, jj
                    ktr= ktr + 1
...
function infinite_loop_check(in_ii, in_jj, in_pii, in_pjj)

implicit none

integer, intent(in) :: in_ii, in_jj, in_pii, in_pjj
logical             :: infinite_loop_check

if ((in_ii == 2 .and. in_pii == 2 .and. abs(in_jj - in_pjj) == 2) .or. &
   (in_jj == 2 .and. in_pjj == 2 .and. abs(in_ii - in_pii) == 2) .or. &
   (abs(in_jj - in_pjj) == 2 .and. abs(in_ii - in_pii) == 2)) then
  infinite_loop_check = .true.
else
  infinite_loop_check = .false.
endif
end function
